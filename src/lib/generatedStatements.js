...
// page's "Generate new statement" action -- same sessionStorage pattern as
// lib/riskProfile.js's getRiskAnswers/setRiskAnswers. Each generate click
...
// planName/period must both be real, non-empty values -- a malformed call
// (missing plan, e.g.) throws instead of silently writing a broken record,
// so a genuine failure surfaces as the error toast rather than a blank
