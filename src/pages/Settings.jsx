...
import { faSun, faMoon, faDesktop, faLock, faCircleCheck } from '@fortawesome/free-solid-svg-icons'
          ...
          <form className="pr-form" onSubmit={submitPassword}>
            ...
            {pwSaved && (
              <p className="settings-pw-saved">
                <Icon icon={faCircleCheck} size={15} /> Password updated.
              </p>
            )}
            <button type="submit" className="btn btn-primary settings-pw-submit">
              <Icon icon={faLock} size={14} /> Update password
            </button>
          </form>
        </ProfileBlock>
      </div>
