...
// one.
const TYPE_TOKENS = [
  { name: 'H1', cls: 'ds-type-h1', family: 'Inclusive Sans', size: '32px', weight: '700–800', lineHeight: '40px (1.25x)', letterSpacing: '-0.4px', case: 'None', real: ['.login-brand-copy h1 · 36/700, -.6px tracking', '.hi-bar h1 · 26/700 (Dashboard), -.4px tracking', '.page-head h1 · 22/700 (Portfolio), -.3px tracking'] },
  { name: 'H2', cls: 'ds-type-h2', family: 'Inclusive Sans', size: '24px', weight: '700–800', lineHeight: '32px (1.33x)', letterSpacing: '-0.3px', case: 'None', real: ['.login-card h2 · 26/700, -.4px tracking', '.section-title · 16/700 (Dashboard), -.2px tracking', '.chart-top h2 · 16/700'] },
  { name: 'H3', cls: 'ds-type-h3', family: 'Inclusive Sans', size: '20px', weight: 700, lineHeight: '28px (1.4x)', letterSpacing: '-0.2px', case: 'None', real: ['.pc-name (PlanCard h3) · 16/700, -.2px tracking', '.summary .head h4 · 16/600, no explicit tracking'] },
  { name: 'H4', cls: 'ds-type-h4', family: 'Inclusive Sans', size: '18px', weight: 700, lineHeight: '24px (1.33x)', letterSpacing: '-0.1px', case: 'None', real: ['.summary .head h4 · 16/600, no explicit tracking'] },
  { name: 'H5', cls: 'ds-type-h5', family: 'Inclusive Sans', size: '16px', weight: 700, lineHeight: '24px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.step .body h3 as a step title · 16/600, no explicit tracking'] },
  { name: 'H6', cls: 'ds-type-h6', family: 'Inclusive Sans', size: '14px', weight: '700–800', lineHeight: '20px (1.43x)', letterSpacing: '0px', case: 'None', real: ['.pc-type · 12/600, no explicit tracking', 'form labels · 12/700'] },
  { name: 'Display Sm', cls: null, family: 'Inclusive Sans', size: '40px', weight: '400–700 (Regular–Bold)', lineHeight: '48px (1.2x)', letterSpacing: '-0.8px', case: 'None', real: ['.rr2-hero-copy b — readiness score figure · 44/800, -1px tracking', '.rg-save-score-row b · 36/800, -1px tracking'] },
  { name: 'Page title', cls: null, family: 'Inclusive Sans', size: '24px', weight: '500–700', lineHeight: '32px (1.33x)', letterSpacing: '-0.3px', case: 'None', real: ['.hi-bar h1 · 26/700 (Dashboard), -.4px tracking'] },
  ...
  { name: 'Description', cls: null, family: 'Inclusive Sans', size: '14px', weight: 400, lineHeight: '21px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.pr-intro · 14/500, no tracking'] },
  { name: 'Title Description', cls: null, family: 'Inclusive Sans', size: '16px', weight: 600, lineHeight: '24px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.login-card h2 sub · 15–16/600, no tracking'] },
  { name: 'Overline / eyebrow', cls: null, family: 'Inclusive Sans', size: '12px', weight: 800, lineHeight: '16px (1.33x)', letterSpacing: '0.4px', case: 'UPPERCASE', real: ['.eyebrow · 12–14px/600–800, uppercase, real tracking .3–.6px (5 different page-scoped rules)', '.learn2-tag · 10/700, uppercase, .7px tracking', '.plan-stat .k / form labels · 12/600–700, uppercase, .3–.4px tracking'] },
