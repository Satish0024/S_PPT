...
// one.
const TYPE_TOKENS = [
  { name: 'H1', cls: 'ds-type-h1', family: 'Inclusive Sans', size: '32px', weight: '700–800', lineHeight: '40px (1.25x)', letterSpacing: '-0.4px', case: 'None', real: ['.login-brand-copy h1 · 32/700, -.6px tracking — now matches token', '.hi-bar h1 · 32/700 (Dashboard), -.4px tracking — now matches token (also claimed by the Page title role at 24px — left resolved to H1 since it was processed first; that duplicate-mapping conflict is unresolved in this doc)', '.page-head h1 · 32/700 (Portfolio), -.3px tracking — now matches token'] },
  { name: 'H2', cls: 'ds-type-h2', family: 'Inclusive Sans', size: '24px', weight: '700–800', lineHeight: '32px (1.33x)', letterSpacing: '-0.3px', case: 'None', real: ['.login-card h2 · 24/700, -.4px tracking — now matches token', '.section-title · 24/700 (Dashboard), -.2px tracking — now matches token (also claimed by the Heading role at 20px — left resolved to H2 since it was processed first; that duplicate-mapping conflict is unresolved in this doc)', '.chart-top h2 · 24/700 — now matches token'] },
  { name: 'H3', cls: 'ds-type-h3', family: 'Inclusive Sans', size: '20px', weight: 700, lineHeight: '28px (1.4x)', letterSpacing: '-0.2px', case: 'None', real: ['.pc-name (PlanCard h3) · 20/700, -.2px tracking — now matches token', '.summary .head h4 · 20/600, no explicit tracking — now matches token (also claimed by the H4 role at 18px — left resolved to H3 since it was processed first; that duplicate-mapping conflict is unresolved in this doc)'] },
  { name: 'H4', cls: 'ds-type-h4', family: 'Inclusive Sans', size: '18px', weight: 700, lineHeight: '24px (1.33x)', letterSpacing: '-0.1px', case: 'None', real: ['.summary .head h4 · 20/600, no explicit tracking — already resized under the H3 role (same selector, conflicting target); not re-edited here'] },
  { name: 'H5', cls: 'ds-type-h5', family: 'Inclusive Sans', size: '16px', weight: 700, lineHeight: '24px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.step .body h3 as a step title · 16/600, no explicit tracking — now matches token'] },
  { name: 'H6', cls: 'ds-type-h6', family: 'Inclusive Sans', size: '14px', weight: '700–800', lineHeight: '20px (1.43x)', letterSpacing: '0px', case: 'None', real: ['.pc-type · 14/600, no explicit tracking — now matches token (also claimed by the Body Extra Small role at 12px — left resolved to H6 since it was processed first; that duplicate-mapping conflict is unresolved in this doc)', 'form labels · 12/700 — skipped: too many distinct label rules (.txn-field label, .field-label, .risk-picker-label, .rq-field label, .field label, etc.) to pick one without guessing'] },
  { name: 'Display Sm', cls: null, family: 'Inclusive Sans', size: '40px', weight: '400–700 (Regular–Bold)', lineHeight: '48px (1.2x)', letterSpacing: '-0.8px', case: 'None', real: ['.rr2-hero-copy b — readiness score figure · 40/800, -1px tracking — now matches token', '.rg-save-score-row b · 40/800, -1px tracking — now matches token'] },
  { name: 'Page title', cls: null, family: 'Inclusive Sans', size: '24px', weight: '500–700', lineHeight: '32px (1.33x)', letterSpacing: '-0.3px', case: 'None', real: ['.hi-bar h1 · 32/700 (Dashboard), -.4px tracking — already resized to the H1 token (32px) under the H1 role; not re-edited here, conflict unresolved'] },
  { name: 'Heading', cls: null, family: 'Inclusive Sans', size: '20px', weight: '500–700', lineHeight: '28px (1.4x)', letterSpacing: '-0.2px', case: 'None', real: ['.section-title · 24/700, -.2px tracking — already resized to the H2 token (24px) under the H2 role; not re-edited here, conflict unresolved'] },
  { name: 'Body Large', cls: null, family: 'Inclusive Sans', size: '16px', weight: '400–600', lineHeight: '24px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.pr-intro · 14/500, no tracking — NOT resized to Body Large\'s 16px: this selector is also claimed by Body Regular/Paragraph Small/Description, all of which already agreed with its real 14px value, so it was tokenized to --text-paragraph-sm-size (14px) under Paragraph Small instead — Body Large\'s 16px mapping looks like a data error in this table'] },
  { name: 'Body Regular', cls: 'ds-type-p2', family: 'Inclusive Sans', size: '14px', weight: '400–600', lineHeight: '21px (1.5x)', letterSpacing: '0px', case: 'None', real: ['table cells (.tx-table td) · 14/400, no tracking — skipped: .tx-table td has no font-size of its own, it inherits 14px from the parent .tx-table{font-size:14px} rule; no distinct rule to point a token at'] },
  { name: 'Body Small', cls: 'ds-type-p3', family: 'Inclusive Sans', size: '14px', weight: 600, lineHeight: '21px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.ob-k · 14/600, no tracking — now matches token'] },
  { name: 'Body Extra Small', cls: 'ds-type-caption', family: 'Inclusive Sans', size: '12px', weight: 700, lineHeight: '18px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.pc-type · 14/600, no tracking — already resized to the H6 token (14px) under the H6 role; not re-edited here, conflict unresolved', '.plan-badge · 12/700, no tracking — now matches token'] },
  { name: 'Paragraph Small', cls: null, family: 'Inclusive Sans', size: '14px', weight: '400–600', lineHeight: '21px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.pr-intro · 14/500, no tracking — now matches token (--text-paragraph-sm-size); also claimed by Body Large/Description, see notes there'] },
  { name: 'Paragraph Extra Small', cls: null, family: 'Inclusive Sans', size: '12px', weight: 700, lineHeight: '18px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.plan-badge · 12/700, no tracking — already resized under Body Extra Small to --text-body-xs-size; numerically identical to --text-paragraph-xs-size (both 12px) so the visible value already matches, token name left as-is'] },
  { name: 'Description', cls: null, family: 'Inclusive Sans', size: '14px', weight: 400, lineHeight: '21px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.pr-intro · 14/500, no tracking — already resized under Paragraph Small to --text-paragraph-sm-size; numerically identical to --text-description-size (both 14px) so the visible value already matches, token name left as-is'] },
  { name: 'Title Description', cls: null, family: 'Inclusive Sans', size: '16px', weight: 600, lineHeight: '24px (1.5x)', letterSpacing: '0px', case: 'None', real: ['.login-card h2 sub · 15–16/600, no tracking — skipped: no such sub-element exists in login.css; closest candidate is .login-lead at 14/400 (--text-description-size), which does not match this row\'s description well enough to guess'] },
  { name: 'Overline / eyebrow', cls: null, family: 'Inclusive Sans', size: '12px', weight: 800, lineHeight: '16px (1.33x)', letterSpacing: '0.4px', case: 'UPPERCASE', real: ['.eyebrow · 12/600–800, uppercase, real tracking .3–.6px (5 page-scoped rules: .ds-hero, .detail-head, .page-intro, .req-plan-strip, .page-head — all now sized to the token)', '.learn2-tag · 12/700, uppercase, .7px tracking — now matches token', '.plan-stat .k · 12/600, uppercase, .3px tracking — now matches token; "form labels" portion of this entry skipped, same ambiguity as the H6 role'] },
  { name: 'Button label', cls: null, family: 'Inclusive Sans', size: '14px', weight: 700, lineHeight: '20px (1.43x)', letterSpacing: '0px', case: 'None', real: ['.btn · 14/700 — already uses var(--text-button-md-size), no change needed', '.step .body h3 as a step title · 16/600 — NOT resized here: this is the same selector already resized to the H5 token (16px) under the H5 role; a step title being mapped to "Button label" looks like a data error, since it is a heading, not a button'] },
]
